...
## Building XH series extension cables

Parts needed:
* XH male connector
* XH female-female wire
* Heat shrink tube
...
## Building Extension wire base -  Base Distribution PCB
...
Solder connectors based on the image below.

## Robot to Source Control Box Cable

Parts needed:
* 2 x GX16 4PIN
*  Twisted Pair Shielded Cable 4 cores - 24AWG or 22AWG
Link - https://s.click.aliexpress.com/e/_c34NcZIT
